...
import { deleteVacansy, Vacancy, VacancyPostFromAdminDelete } from '@/lib/actions/action'
...
const page = async () => {
    ...
    return (
        <section className={styles.content}>
                        ...
                        : Vacancies.map((el, idx) => (
                            <div key={idx}>
                                ...
                                <section className={styles.edit}>
                                    <button>
                                        <Link href={`dashboard/postDetail/${el.path}/${el.id}`}>
            ...
            <div className={`${styles.row} font-poppions-light`}>
                {
                    VacanciesAdmin.length === 0 ?
                        <p className={`${styles.checked} font-poppions-light`}>
                            Checked
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path d="M256 48a208 208 0 1 1 0 416 208 208 0 1 1 0-416zm0 464A256 256 0 1 0 256 0a256 256 0 1 0 0 512zM369 209c9.4-9.4 9.4-24.6 0-33.9s-24.6-9.4-33.9 0l-111 111-47-47c-9.4-9.4-24.6-9.4-33.9 0s-9.4 24.6 0 33.9l64 64c9.4 9.4 24.6 9.4 33.9 0L369 209z" /></svg>
                        </p>
                        : VacanciesAdmin.map((el, idx) => (
                            <div key={idx}>
                                <img src={el?.company_logo} alt="" />
                                <h4> {el?.job_title} </h4>
                                <span>{el?.company_name}</span>
            ...
            <div className={styles.create}>
                <Link className='font-poppions-light' href={'dashboard/adminPost'}>
